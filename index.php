    ...
    <footer class="footer" style="background-color: #ffc82d;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-4">
                    <span class="copyright">Copyright &copy; OPSIW PUC</span>
                </div>
                <div class="col-md-4">
                    <ul class="list-inline endereco">
                        ...
                        <li class="list-inline-item">
                            <a href="https://api.whatsapp.com/send?1=ptBR&phone=5514991220621" target="_blank" style="text-decoration: none; color: #d3222a;">(14) 99122 0621
